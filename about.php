    ...
    <div class="container mt-5">
        ...
        <section id="mission" class="mt-5 text-center">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <img src="https://media.istockphoto.com/id/889968488/photo/skill-concept.jpg?s=612x612&w=0&k=20&c=yDPoLvtvsnNbJQffOO8iMtfofeYLZ-r4PIdFCH7hBtc=" class="img-fluid rounded" alt="Mission Image">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        <div class="card shadow-sm">
                            <img src="https://media.licdn.com/dms/image/v2/C5612AQG6MflTbTCxfA/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1520083560509?e=2147483647&v=beta&t=wgIf_lW0QjOsYFRBIClNVqBVltMEVv7IupgxNXqwZGU" class="card-img-top" alt="NCS">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm">
                            <img src="https://static.mygov.in/static/s3fs-public/mygov_147379768343741641.jpg" class="card-img-top" alt="NSDA">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm">
                            <img src="https://www.devdiscourse.com/remote.axd?https://devdiscourse.blob.core.windows.net/devnews/05_09_2019_16_08_45_9875284.jpg?width=1280" class="card-img-top" alt="Skill India">
                            <div class="card-body">
        ...
        <section id="statistics" class="mt-5 text-center">
            <div class="container">
                ...
                <img src="https://cdn2.hubspot.net/hub/53/file-2390462434-png/00-Blog_Thinkstock_Images/analytics-reports.png" class="img-fluid rounded" alt="Statistics Image">
            </div>
        </section>
        ...
        <section id="success-stories" class="mt-5 text-center">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <img src="https://static.vecteezy.com/system/resources/thumbnails/015/512/347/small_2x/success-story-to-motivate-people-to-develop-and-improve-to-achieve-life-success-telling-story-or-inspire-people-aspiration-concept-businessman-telling-success-story-with-megaphone-on-winner-trophy-vector.jpg" class="card-img-top" alt="Success Story 1">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <img src="https://t4.ftcdn.net/jpg/04/38/59/53/360_F_438595346_MMK0Me1ckaIG1lIa6vZawA0BOvS7jnSv.jpg" class="card-img-top" alt="Success Story 2">
                            <div class="card-body">
