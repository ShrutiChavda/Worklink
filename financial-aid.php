...
<div class="container mt-4">
    <section class="section-container">
        ...
        <p>Financial aid options are available to support individuals in pursuing skill training and education. These options include government and private scholarships, grants, loans, and employer-sponsored training programs.</p>
        <div class="text-center mt-3">
            <img src="https://source.unsplash.com/600x400/?scholarship,training" alt="Training Programs" class="img-fluid">
        </div>
    </section>
    ...
    <section class="section-container">
        ...
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">1. Check Eligibility</div>
            <div class="progress-bar" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">2. Select Program</div>
            <div class="progress-bar" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">3. Gather Documents</div>
            <div class="progress-bar" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">4. Submit Application</div>
            <div class="progress-bar" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">5. Await Approval</div>
        </div>
        <div class="text-center mt-3">
