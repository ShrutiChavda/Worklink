                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-info mt-1" data-toggle="modal"
                                        data-target="#applicantModal" data-id="<?= $row['user_id'] ?>"
                                        data-name="<?= htmlspecialchars($row['full_name']) ?>"
                                        data-email="<?= htmlspecialchars($row['email']) ?>"
                                        data-phone="<?= htmlspecialchars($row['phone']) ?>"
                                        data-birthday="<?= $row['birthday'] ?>" data-gender="<?= $row['gender'] ?>"
                                        data-program="<?= htmlspecialchars($row['course_name']) ?>"
                                        data-enroll-date="<?= $row['enrollment_date'] ?>"
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success btn-sm actionBtn"
                                        data-id="<?= $row['enrollment_id'] ?>" data-action="Approved">Approve</button>
                                    <button class="btn btn-danger btn-sm actionBtn"
                                        data-id="<?= $row['enrollment_id'] ?>" data-action="Rejected">Reject</button>
                                    <?php } else { ?>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-md-6 mb-2"><strong>Date of Birth:</strong> <span id="applicantbirthday"></span>
                    </div>
                    ...
                    <div class="col-md-6 mb-2"><strong>Enrollment Date:</strong> <span id="applicantEnrollDate"></span>
                    </div>
