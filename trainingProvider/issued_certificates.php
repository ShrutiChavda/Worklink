        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="certTable" width="100%" cellspacing="0">
                ...
                ?>
                    <tr>
                        <td><?= $count++ ?></td>
                        <td><img src="<?= $userPic ?>" class="img-thumbnail rounded-circle user-pic" alt="User Pic">
                        </td>
                        <td><?= $row['full_name'] ?></td>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>Certificate Number:</strong> <?= $row['certificate_number'] ?>
                                            </p>
                                            <p><strong>Issued On:</strong>
                                                <?= date('d M Y, h:i A', strtotime($row['issue_date'])) ?></p>
                                        </div>
                        ...
                        <td>
                            <a href="certificate_preview.php?id=<?= $row['id'] ?>" class="btn btn-success btn-sm"
                                target="_blank">
