...
<body>
    ...
    <div class="container mt-4">
        <section class="section-container">
            ...
            <p>Workplace safety guidelines are essential for preventing accidents and ensuring a healthy work
                environment. These guidelines cover various aspects of safety, including factory laws, emergency
                protocols, and hazard handling.</p>
            <div class="text-center mt-3">
                <img src="https://source.unsplash.com/600x400/?safety,inspection" alt="Safety Inspection"
                    class="img-fluid">
            </div>
        </section>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/VIDEO_ID_1"
                            title="Fire Drill Demonstration" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/VIDEO_ID_2"
                            title="Evacuation Steps in Case of Emergency" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/VIDEO_ID_3"
                            title="Basic First Aid Training" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="text-center mt-3">
            ...
            <div class="accordion" id="hazardAccordion">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        data-bs-parent="#hazardAccordion">
