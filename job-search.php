...
<div class="hero animate__animated animate__fadeIn">
    ...
    <div class="search-bar">
        ...
        <select><option>Location</option><option>City 1</option><option>City 2</option></select>
        <select><option>Industry</option><option>IT</option><option>Healthcare</option></select>
