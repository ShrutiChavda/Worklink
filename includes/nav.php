<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="index.php">Worklink Dashboard</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="aboutDropdown" role="button" data-bs-toggle="dropdown">
                        About
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="about.php#overview">Overview</a></li>
                        <li><a class="dropdown-item" href="about.php#mission">Mission & Vision</a></li>
                        <li><a class="dropdown-item" href="about.php#initiatives">Key Government Initiatives</a></li>
                        <li><a class="dropdown-item" href="about.php#statistics">Statistics & Reports</a></li>
                        <li><a class="dropdown-item" href="about.php#success-stories">Success Stories</a></li>
                    </ul>
                </li>
