...
<div class="container mt-5">
    ...
    <section id="overview" class="text-center">
        <img src="../assets/images/ncs.png" alt="Overview Image">
    ...
    <section id="mission" class="mt-5 text-center">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="" class="img-fluid rounded" alt="Mission Image">
            </div>
            <div class="col-md-6">
        ...
        <div class="row text-center">
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <img src="../assets/images/ncs.png" class="card-img-top" alt="NCS">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <img src="../assets/images/nsda.png" class="card-img-top" alt="NSDA">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <img src="../assets/images/digihub.png" class="card-img-top" alt="Skill India">
                    <div class="card-body">
    ...
    <section id="statistics" class="mt-5 text-center">
        ...
        <img src="../assets/images/skills.jpg" class="img-fluid rounded" alt="Statistics Image">
    </section>
    ...
    <section id="success-stories" class="mt-5 text-center">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <img src="../assets/images/ncs.png" class="card-img-top" alt="Success Story 1">
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <img src="../assets/images/ncs.png" class="card-img-top" alt="Success Story 2">
                    <div class="card-body">
