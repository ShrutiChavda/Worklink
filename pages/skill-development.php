...
<div class="container mt-4">
    ...
    <div class="section-container">
        <section class="mt-4 text-center">
            ...
            <div class="training-program">
                ...
                <img src="https://www.skillindiadigital.gov.in/assets/images/courses/it.webp" class="section-image img-fluid" alt="IT Training">
            </div>

            <div class="training-program">
                <h3>Manufacturing</h3>
                <p>Training in machine operation, welding, fabrication, and quality control.</p>
                <img src="https://www.msde.gov.in/sites/default/files/inline-images/Manufacturing.jpg" class="section-image img-fluid" alt="Manufacturing Training">
            </div>

            <div class="training-program">
                <h3>Healthcare</h3>
                <p>Programs for medical assistants, nursing, pharmacy technicians, and healthcare administration.</p>
                <img src="https://www.skillindiadigital.gov.in/assets/images/courses/healthcare.webp" class="section-image img-fluid" alt="Healthcare Training">
            </div>

            <div class="training-program">
                <h3>Agriculture</h3>
                <p>Training in modern farming techniques, horticulture, and agricultural technology.</p>
                <img src="https://www.skillindiadigital.gov.in/assets/images/courses/agriculture.webp" class="section-image img-fluid" alt="Agriculture Training">
            </div>

            <button class="btn btn-primary btn-custom" onclick="openPopup('coursesPopup')">View All Programs</button>
        </section>
    </div>
    ...
    <div class="section-container">
        <section class="mt-4 text-center">
            ...
            <p>The National Skill Qualification Framework (NSQF) ensures standardized and nationally recognized skill certifications. Learn how to get certified in your chosen trade and enhance your employability.</p>
    ...
    <div class="section-container">
        <section class="mt-4 text-center">
            ...
            <p>Government subsidies and scholarships are available to support your skill development journey. Find out about eligibility criteria and application processes.</p>
            <button class="btn btn-success btn-custom" onclick="openPopup('schemesPopup')">Explore Financial Aid</button>
        </section>
    </div>
    ...
    <div class="section-container">
        <section class="mt-4 text-center">
            ...
            <p>Find government-approved skill development centers in your region. These centers offer a range of training programs and resources.</p>
            <button class="btn btn-warning btn-custom" onclick="openPopup('centersPopup')">Find Training Centers</button>
        </section>
    </div>
</div>
