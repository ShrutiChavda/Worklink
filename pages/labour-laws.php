...
<div class="container mt-4">
    <section class="section-container">
        ...
        <p>Labour laws in India are designed to protect the rights of workers and ensure fair employment practices. Here's an overview of key labour laws:</p>
        <ul>
            <li><strong>The Minimum Wages Act, 1948:</strong> Sets minimum wages for workers.</li>
            <li><strong>The Factories Act, 1948:</strong> Ensures safety, health, and welfare of workers in factories.</li>
            <li><strong>The Industrial Disputes Act, 1947:</strong> Provides mechanisms for resolving industrial disputes.</li>
            <li><strong>The Employees' Provident Funds and Miscellaneous Provisions Act, 1952:</strong> Provides social security benefits.</li>
            <li><strong>The Maternity Benefit Act, 1961:</strong> Protects the employment of women during maternity.</li>
            <li><strong>The Payment of Gratuity Act, 1972:</strong> Provides for payment of gratuity to employees.</li>
            <li><strong>The Contract Labour (Regulation and Abolition) Act, 1970:</strong> Regulates the employment of contract labour.</li>
        </ul>
    </section>
    ...
    <section class="section-container">
        ...
        <ul>
            <li><strong>Conciliation:</strong> A third party facilitates discussions between the employer and employees.</li>
            <li><strong>Mediation:</strong> A neutral mediator helps the parties reach a mutually agreeable solution.</li>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        The minimum wage varies by state and industry. Please refer to the state-specific minimum wage notifications.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        You can file a complaint with the labour commissioner or through the online grievance portal.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        You have the right to maternity leave for up to 90 days. You can apply for leave through the employer's website or by filing a notice of leave with the labour commissioner.
                    </div>
    </div>
    </div>
    </section>
