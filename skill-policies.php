...
<body>
    ...
    <div class="container mt-4">
        <section class="section-container">
            ...
            <p>Government skill development policies and initiatives are designed to enhance employability and foster
                economic growth. Skill training programs provide individuals with the necessary skills to secure better
                job opportunities.</p>
            <div class="text-center mt-3">
                <img src="https://source.unsplash.com/600x400/?training,workshop" alt="Training Programs"
                    class="img-fluid">
            </div>
        </section>
        ...
        <section id="registration-process" class="section-container">
            ...
            <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0"
                    aria-valuemax="100">1. Visit Portal</div>
                <div class="progress-bar" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0"
                    aria-valuemax="100">2. Create Account</div>
            </div>
        </section>
    </div>
