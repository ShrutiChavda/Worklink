...
<body>
    ...
    <div class="container mt-4">
        <section class="section-container">
            ...
            <p>Entrepreneurship is vital for economic growth, and the government offers numerous support schemes for
                startups. This page provides a comprehensive guide to starting and growing your business.</p>
            <div class="text-center mt-3">
                <img src="https://source.unsplash.com/600x400/?business,founders" alt="Business Founders"
                    class="img-fluid">
            </div>
            <div class="text-center mt-3">
            ...
            <div class="accordion" id="schemeAccordion">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        data-bs-parent="#schemeAccordion">
