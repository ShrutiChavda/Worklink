...
<body>
    ...
    <div class="container mt-4">
        <section class="section-container">
            ...
            <p>Employment reports and statistics provide valuable insights into the job market, labor trends, and
                sector-wise growth. These data-driven reports help individuals and businesses make informed decisions.
            </p>
            ...
            <div class="accordion" id="sectorDataAccordion">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        data-bs-parent="#sectorDataAccordion">
